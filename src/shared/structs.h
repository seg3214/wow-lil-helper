...
struct SpellEntry {
	...
	uint32_t Stances;     //uint32 ShapeshiftMask[2];                               // 12-13
	uint32_t unk_320_2;   //uint32 ShapeshiftMask[2];                               // 12-13
	uint32_t StancesNot;  //uint32 ShapeshiftExclude[2];                            // 14-15
	uint32_t unk_320_3;   //uint32 ShapeshiftExclude[2];                            // 14-15
	uint32_t Targets;
